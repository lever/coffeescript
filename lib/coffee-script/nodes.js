...
(function() {
  ...
  UTILITIES = {
    extend: function(o) {
      return "function(child, parent) { for (var key in parent) { if (" + (utility('hasProp', o)) + ".call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; if (Object.setPrototypeOf) { Object.setPrototypeOf(child, parent); } else { child.__proto__ = parent; } return child; }";
    },
    bind: function() {
